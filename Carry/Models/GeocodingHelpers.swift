...
/// Returns the geographic centroid for a given ISO 3166-1 alpha-2 country code.
func coordinatesForCountry(_ code: String) -> (lat: Double, lon: Double)? {
    countryCentroids[code.uppercased()]
}
