...
struct TripBookStats: Equatable {
    ...
    /// 最常去前 N（默认 3）国家/地区。
    var topCountries: [CountryTally] { Array(countryTallies.prefix(3)) }
    ...
    static func compute(
        ...
        for t in inputs {
            ...
            if let y = t.departureYear, !t.isDateless {
