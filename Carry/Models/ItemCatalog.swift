...
let itemPickerCatalog: [ItemPickerCategory] = [
    ...
    ItemPickerCategory(name: "Makeup", items: [
        ...
        "Eyebrow pencil", "Mascara", "Eyeliner", "Eyeshadow",
        "Blush", "Highlighter",
        "Setting powder",
    ...
    ItemPickerCategory(name: "Health & Wellness", items: [
        ...
        "Contact lenses",
        "Hand sanitizer", "First aid kit", "Wet wipes",
