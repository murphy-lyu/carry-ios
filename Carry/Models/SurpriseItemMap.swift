...
let surpriseItemMap: [String: [SurpriseItem]] = [
    ...
    "honeymoon": [
        ...
        SurpriseItem(name: "Bath salts",
                     ...
                     category: .toiletries),
        SurpriseItem(name: "Silk sleep mask",
                     note: "Softer and cooler than a regular eye mask — a small upgrade that makes the nights feel like they belong to the trip",
                     category: .essentials),
    ...
    "tropical": [
        ...
        SurpriseItem(name: "Reef-safe sunscreen",
                     ...
                     category: .health),
        SurpriseItem(name: "After-sun gel",
                     note: "Skin that's had a good day in the sun deserves this in the evening — the difference between waking up glowing and waking up sore",
                     category: .health),
...
private let surpriseFunctionalOverlapKeywords: [String: [String]] = [
    ...
    "Book": ["book", "e-reader"],
    "After-sun gel": ["after-sun", "sun lotion", "after sun"],
    "Waterproof phone pouch": ["waterproof bag", "phone case"],
    "Bath salts": ["bath salts"],
    "Silk sleep mask": ["eye mask", "sleep mask"],
