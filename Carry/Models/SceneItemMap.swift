...
let sceneItemMap: [String: [SceneItem]] = [
    ...
    "tropical": [
        ...
        makeSceneItem("Rash guard", isAlert: false),
        makeSceneItem("Swimming goggles", isAlert: false),
    ...
    "winter": [
        ...
        makeSceneItem("Heat patches", isAlert: false),
        makeSceneItem("Thermal socks", isAlert: false),
    ...
    "remote_work": [
        ...
        makeSceneItem("Power strip", isAlert: false),
    ],
    "kids": [
        ...
        makeSceneItem("Travel board game", isAlert: false),
