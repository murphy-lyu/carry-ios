    ...
    static let embeddedDefault = RoadmapPayload(
        ...
        sections: [
            ...
            RoadmapSection(
                ...
                items: [
                    RoadmapItem(id: "trip-planning", title: RoadmapL10n.text(en: "Trip planning: places & routes by day", zhHans: "行程规划：按天安排地点与路线", zhHant: "行程規劃：按日安排地點與路線"), status: .done, note: nil),
                    ...
                    RoadmapItem(id: "trip-reminders", title: RoadmapL10n.text(en: "Trip reminders (departure, flights, checkout)", zhHans: "行程提醒（出发 · 航班 · 退房）", zhHant: "行程提醒（出發 · 航班 · 退房）"), status: .done, note: nil),
                    ...
                    RoadmapItem(id: "icloud-sync", title: RoadmapL10n.text(en: "iCloud sync across devices", zhHans: "iCloud 多设备同步", zhHant: "iCloud 多裝置同步"), status: .done, note: nil),
                    RoadmapItem(id: "attachments", title: RoadmapL10n.text(en: "Trip attachments (bookings, documents, photos)", zhHans: "行程附件（订单 · 证件 · 照片）", zhHant: "行程附件（訂單 · 證件 · 相片）"), status: .done, note: nil),
                    RoadmapItem(id: "calendar-sync", title: RoadmapL10n.text(en: "Sync to your calendar", zhHans: "同步到系统日历", zhHant: "同步到系統行事曆"), status: .done, note: nil),
                    RoadmapItem(id: "share-list", title: RoadmapL10n.text(en: "Share your packing list", zhHans: "分享打包清单", zhHant: "分享打包清單"), status: .done, note: nil),
                    RoadmapItem(id: "quick-actions", title: RoadmapL10n.text(en: "Home Screen quick actions", zhHans: "主屏长按快捷操作", zhHant: "主畫面長按快速操作"), status: .done, note: nil),
                    ...
                    RoadmapItem(id: "packing-reminder", title: RoadmapL10n.text(en: "Packing reminders", zhHans: "打包提醒通知", zhHant: "打包提醒通知"), status: .done, note: nil),
                    RoadmapItem(id: "trip-background", title: RoadmapL10n.text(en: "Custom trip cover photo", zhHans: "自定义行程封面图", zhHant: "自訂行程封面圖"), status: .done, note: nil),
                    RoadmapItem(id: "worth-considering", title: RoadmapL10n.text(en: "Little Joys — thoughtful nudges", zhHans: "小确幸 · 贴心提醒", zhHant: "小確幸 · 貼心提醒"), status: .done, note: nil),
                    RoadmapItem(id: "custom-section", title: RoadmapL10n.text(en: "Custom list categories", zhHans: "自定义清单分类", zhHant: "自訂清單分類"), status: .done, note: nil),
                    RoadmapItem(id: "sorting", title: RoadmapL10n.text(en: "Reorder items & categories", zhHans: "物品与分类排序", zhHant: "物品與分類排序"), status: .done, note: nil),
                    RoadmapItem(id: "item-quantity", title: RoadmapL10n.text(en: "Item quantities", zhHans: "物品数量设置", zhHant: "物品數量設定"), status: .done, note: nil),
                    RoadmapItem(id: "trip-duplicate", title: RoadmapL10n.text(en: "Duplicate a trip", zhHans: "一键复制行程", zhHant: "一鍵複製行程"), status: .done, note: nil),
                    RoadmapItem(id: "backup-restore", title: RoadmapL10n.text(en: "Backup & restore", zhHans: "备份与还原", zhHant: "備份與還原"), status: .done, note: nil),
                    RoadmapItem(id: "app-icons", title: RoadmapL10n.text(en: "App icon themes", zhHans: "多套 App 图标主题", zhHant: "多套 App 圖示主題"), status: .done, note: nil)
                ]
            )
        ]
    )
